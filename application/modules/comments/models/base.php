...
class Base extends CI_Model
{
    ...
    public function get_item_comments_status($item_id) {
        ...
        if ($query->num_rows() == 1) {
            ...
            return $status['comments_status'] == 1;
        } else {
            return FALSE;
        }
    }
    ...
    public function get_settings() {
        return ModuleSettings::ofModule('comments')->get();
    }
    ...
    public function save_settings($data) {
        ModuleSettings::ofModule('comments')->set($data);
    }
    ...
    public function get_count_comments($id) {
        ...
        return $test->num_rows() > 0 ? $test->row()->count : 0;
    }
